/** @author:dereksu @description:http://km.oa.com/group/TGideas/articles/show/264281 @update:2017.05.05 @version:beta @dependencies:pc-jQuery,m-Zepto @path://game.gtimg.cn/images/js/su/danMu.beta.min.js **/
function aDanMu(f) {
    this.opt = {
    ...
    this.fly = function(e) {
        ...
        return "m" === this.danMuStage.opt.device ? ($(this.dom).data("dmid", "dm-" + this.danMuStage.dmId), e = this.dom.cloneNode(!0), $(e).data("dmid", "dm-temp-" + this.danMuStage.dmId).addClass("dmtemp"), this.dom.style.display =
            "none", this.dom.parentNode.insertBefore(e, this.dom), this.danMuStage.dmId += 1, f = "left" === this.danMuStage.opt.mAnimation ? {
                left: f + "px"
            } : {
...
function danMu(f) {
    ...
    this.createAllDanMu = function(b, a, c) {
        ...
        if (d.opt.autoplay) {
            ...
            else d.curIndex > d.opt.leastNum ? d.curIndex = e < d.opt.leastNum ? 0 : d.curIndex : null, f = c ? 0 : d.opt.timeInterval * d.curIndex;
            setTimeout(function() {
    ...
    this.send = function(b, a) {
        if (this.isStop) this.util.tcssImgLoader("tgideas.qq.com", "danmu.send_fail.stop." + this.util.cfg.cUrl), alert(this.opt.sendIfStopTips);
    ...
    this.triggerSend = function(b, a) {
        ...
        if ("object" !== typeof b) c("Parameter format error!");
            ...
            if (this.isStop) c("The danmu has stopped.");
                ...
                if (this.opt.uniqueTagName)
                    if ("object" === typeof d && "undefined" !== typeof d.comment && "undefined" !== typeof d[this.opt.uniqueTagName]) c = d, b && this.comments.push(c), "undefined" !== typeof e ? this.createDanMu(this.opt.danMuHtml.replace(/{userId}/g,
                        c[this.opt.uniqueTagName]).replace(/{comment}/g, c.comment), !1, !1, e) : this.createDanMu(this.opt.danMuHtml.replace(/{userId}/g, c[this.opt.uniqueTagName]).replace(/{comment}/g, c.comment), !1, !1), c = null;
                    else {
                        c("Data format error!");
                        return
                    }
    ...
    this.play = function(b) {
        ...
        if (a.isStop) {
            a.isStop = !1;
            a.opt.autoplay || ("string" === typeof a.opt.alwaysDanMuHtml && "" !== a.opt.alwaysDanMuHtml ? a.createDanMu(a.opt.alwaysDanMuHtml, !0, !1) : a.opt.alwaysDanMuHtml.constructor === Array && 0 < a.opt.alwaysDanMuHtml.length && (a.createDanMu(a.opt.alwaysDanMuHtml[a.awDanMuHtmlCurIndex], !0, !1), a.awDanMuHtmlCurIndex = a.awDanMuHtmlCurIndex < a.opt.alwaysDanMuHtml.length - 1 ? a.awDanMuHtmlCurIndex + 1 : 0), a.opt.autoplay = !0);
            if ("m" === a.opt.device) {
    ...
    if (0 == this.opt.comments.length) this.isOver = !0;
        ...
        if (this.opt.uniqueTagName) this.comments = this.opt.comments, this.position.y = 0, this.createAllDanMu(this.opt.uniqueTagName, this.opt.userId);
        else {
