$(document).ready(function(){
	...
	$(".scenery area").click(function(){
		...
		showDialog.show(big_pic);
		var mheight=$(".scen img").eq(numShow).height();
		if(mheight>575){ 	$(".scen img").eq(numShow).height(575).width(330)};
...
var share_config = { 
	...
	pic:'http://img1.tiancitycdn.com/eve/event/monument/images/share_pic.jpg'
}
